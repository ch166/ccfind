...
def found_card(input_line, cardType, found_match, linenum, input_filename):
    """Report card discovery information"""
    print(
        f"{BLUE}{input_filename}[!]{GREEN}line:{linenum} Potential {cardType} card found"
    )
    print(f"{RED}Regex Match: {found_match.group(0)}")
